...
def parse_args():
    ...
    parser.add_argument('--fer_path', type=str, default='/data/dataset/fer/fer_112_112_data/open_data/ferPlus/', help='ferPlus-DB dataset path.')
...
#        transforms.ColorJitter(),        
    ...
    train_dataset = datasets.ImageFolder(f'{args.fer_path}/train', transform = data_transforms)   # loading statically	 
    ...
    val_dataset = datasets.ImageFolder(f'{args.fer_path}/test', transform = data_transforms_val)    # loading statically	
